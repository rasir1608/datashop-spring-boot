...
CREATE TABLE IF NOT EXISTS `d_interface` (
  ...
  `path` varchar(255) DEFAULT NULL comment "接口url",
  ...
  `creator` int(11) DEFAULT NULL comment "接口创建者",
  `modifier` int(11) DEFAULT NULL comment "接口修改者",
  `request` text comment "接口请求信息",
  `response` text comment "接口返回信息",
  `project` int(11) DEFAULT NULL comment "接口所属系统ID",
  `remarks` varchar(255) comment "接口备注",
